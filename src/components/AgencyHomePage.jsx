        ...
        <nav className="pointer-events-auto bg-white/95 backdrop-blur-md border border-slate-200/90 rounded-full px-5 py-3 shadow-lg flex items-center justify-between w-full max-w-5xl transition-all duration-300">
          ...
          <div className="hidden md:flex items-center space-x-7 text-xs font-semibold text-slate-700">
            ...
            >
              ...
              {isMegaMenuOpen && (
                <div className="absolute top-full -left-12 w-[480px] bg-white/98 backdrop-blur-xl border border-slate-200 rounded-2xl p-4 shadow-2xl space-y-3 pt-3 animate-in fade-in zoom-in-95 duration-200">
                  <p className="text-[10px] font-extrabold uppercase tracking-wider text-slate-400 px-2">Our Services</p>
                  <div className="grid grid-cols-2 gap-2">
                    <a href="#services" className="p-2.5 rounded-xl hover:bg-slate-50 flex items-start space-x-3 transition-all hover:translate-x-1">
            ...
            <a href="#projects" className="hover:text-blue-600 transition-colors">Gallery</a>
      ...
      <section className="pt-32 pb-20 px-4 md:px-8 max-w-6xl mx-auto text-center space-y-8 relative">
        ...
        <div className="pt-10 max-w-4xl mx-auto relative flex flex-col md:flex-row items-center justify-center gap-8">
          ...
          <div className="hidden lg:flex flex-col space-y-4 shrink-0 animate-float">
            ...
            <div className="w-12 h-12 rounded-2xl bg-emerald-500 text-white flex items-center justify-center shadow-lg hover:rotate-12 transition-transform"><MessageSquare className="w-6 h-6" /></div>
      ...
      <section id="services" className="py-20 px-4 max-w-6xl mx-auto space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="glass-card p-6 rounded-2xl space-y-3">
            ...
            <h3 className="font-bold text-base text-slate-900">Business Website Development</h3>
          ...
          <div className="glass-card p-6 rounded-2xl space-y-3">
            ...
            <h3 className="font-bold text-base text-slate-900">AI Automation</h3>
            <p className="text-xs text-slate-600 leading-relaxed">
          ...
          <div className="glass-card p-6 rounded-2xl space-y-3">
            ...
            <h3 className="font-bold text-base text-slate-900">WhatsApp Automation</h3>
            <p className="text-xs text-slate-600 leading-relaxed">
          ...
          <div className="glass-card p-6 rounded-2xl space-y-3">
            ...
            <h3 className="font-bold text-base text-slate-900">Custom Business Software</h3>
            <p className="text-xs text-slate-600 leading-relaxed">
          ...
          <div className="glass-card p-6 rounded-2xl space-y-3">
            ...
            <h3 className="font-bold text-base text-slate-900">Landing Pages</h3>
            <p className="text-xs text-slate-600 leading-relaxed">
          ...
          <div className="glass-card p-6 rounded-2xl space-y-3">
            ...
            <h3 className="font-bold text-base text-slate-900">UI/UX Design</h3>
            <p className="text-xs text-slate-600 leading-relaxed">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-1">
                ...
                <textarea
                  ...
                  className="w-full bg-slate-50 border border-slate-300 rounded-xl p-3 text-xs text-slate-900 focus:outline-none focus:border-blue-600 transition-all focus:ring-2 focus:ring-blue-600/20"
                />
              </div>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-5 gap-8 text-xs">
          ...
          <div className="space-y-2">
            ...
            <ul className="space-y-1.5 text-slate-400">
              ...
              <li><a href="#solutions" className="hover:text-white transition-colors">Healthcare</a></li>
              <li><a href="#solutions" className="hover:text-white transition-colors">Retail</a></li>
              <li><a href="#solutions" className="hover:text-white transition-colors">Gyms</a></li>
            </ul>
          </div>
          ...
          <div className="space-y-2">
            ...
            <ul className="space-y-1.5 text-slate-400">
              ...
              <li><button onClick={onNavigateAdmin} className="hover:text-blue-400 text-blue-400 font-bold">Admin Login</button></li>
            </ul>
          </div>
        </div>
